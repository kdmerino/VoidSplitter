...
#ifndef GOOGLE_PROTOBUF_INCLUDED_hello_2dworld_2drequest_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_hello_2dworld_2drequest_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_hello_2dworld_2drequest_2eproto;
namespace cpp {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::cpp::HelloWorldRequest* Arena::CreateMaybeMessage<::cpp::HelloWorldRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace cpp {
...
class HelloWorldRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cpp.HelloWorldRequest) */ {
 public:
  inline HelloWorldRequest() : HelloWorldRequest(nullptr) {}
  ~HelloWorldRequest() override;
  explicit PROTOBUF_CONSTEXPR HelloWorldRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  HelloWorldRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit HelloWorldRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
// optional string name = 1;
inline bool HelloWorldRequest::_internal_has_name() const {
...
void HelloWorldRequest::set_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
inline void HelloWorldRequest::set_allocated_name(std::string* name) {
  if (name != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_hello_2dworld_2drequest_2eproto
